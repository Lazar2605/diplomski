...
class ProdavacProfilePage extends React.Component {
  constructor(props) {
    super(props);
  ...
  getMarks() {
    api("ocene/" + this.id, "get", {}, "posetilac")
    .then((res) => {
  ...
  render() {
    ...
    singleArticle(article) {
        return (
            <SingleArticlePreview article={article} otvoriProdavca="false"/>
        );
    }
}

export default ProdavacProfilePage;
