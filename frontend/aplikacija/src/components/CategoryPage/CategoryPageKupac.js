...
export default class CategoryPageKupac extends React.Component {
    constructor(props) {
        super(props);
          ...
          <Col lg="3" md="4" sm="6" xs="12">
            <Card className="mb-3">
              <Card.Body>
                ...
                <Link to = {`korisnik/kategorija/${ category.id}`} className="btn btn-primary w-100 btn-sm">
                Otvori kategoriju
                </Link>
              </Card.Body>
            </Card>
    ...
    singleArticle(article) {
        return (
          <SingleArticlePreviewKupac article={article} />
        );
    }
    ...
    getCategoryData() {
        ...
        "?populate=prodavac&keywords="+ this.state.filters.keywords + 
