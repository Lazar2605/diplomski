...
export class UserRegistrationPageKorisnik extends React.Component {
    constructor(props) {
        super(props);
        ...
        <Container>
            ...
            <Col md = { { span: 8, offset: 2 } }>
                <Card style={{ backgroundColor: '#e6fff2' }}>
                    <Card.Body>
                        <Card.Title>
                            <FontAwesomeIcon icon = { faUserPlus }></FontAwesomeIcon> Registracija korisnika
                        </Card.Title>
                        {
            ...
            <>
                <Form>
                    ...
                    <Row>
                        ...
                        <Col md = "6">
                            <Form.Group>
                                <Form.Label htmlFor = "lozinkaPonovljena"> Ponovljena lozinka: </Form.Label>
                                <Form.Control type = "password" id = "lozinkaPonovljena" 
                                                value = { this.state.formData.lozinkaPonovljenanka } 
                                                onChange =  { event => this.formInputChanged(event) } />
                            </Form.Group>
                        </Col>
                    </Row>
